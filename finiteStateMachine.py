...
####### Here beings the code I wrote for the course : 
def reverse(edges,accepting,start): 
        ...
        for k in edges:
            ...
            for dest_state in dest_states:
                before = []
                if (dest_state,letter) in new_edges:
                    before = new_edges[(dest_state,letter)]
                new_edges[(dest_state,letter)] = [start_state] + before
        return (new_edges, new_accepting, new_start)

####### Finished Code Writing
